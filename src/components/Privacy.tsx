import { Modal, Title, Text, Anchor, Space, List } from '@mantine/core'

function Privacy({ opened, setOpened }: any) {
  return (
    <>
      <Modal
        opened={opened}
      ...
      >
        ...
        <Text>
          Your privacy is important to us. It is Listed&#39;s policy to respect your privacy and
          ...
          <Anchor href='https://listed.fyi'>https://listed.fyi</Anchor>, and other sites we own and
          operate.{' '}
        </Text>
        <Text>
          This policy is effective as of 14 May 2022 and was last updated on 14 May 2022.{' '}
        </Text>
        ...
        <Title order={2}>Disclosure of Personal Information to Third Parties</Title>
        ...
        <Title order={2}>International Transfers of Personal Information</Title>
        <Text>
        ...
        <Title order={2}>Your Rights and Controlling Your Personal Information</Title>
        <Text>
        ...
        <Title order={2}>Limits of Our Policy</Title>
        <Text>
